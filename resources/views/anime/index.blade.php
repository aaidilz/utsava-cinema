    ...
    <main class="min-h-screen pt-24 pb-20 px-4 md:px-6 container mx-auto max-w-7xl">
        ...
        <div class="mb-10 text-center space-y-4">
            ...
            <form action="{{ route('anime.search') }}" method="GET" class="relative max-w-2xl mx-auto group">
                ...
                <div
                    class="relative flex items-center bg-[#1a1a20] border border-white/10 rounded-full overflow-hidden shadow-2xl focus-within:border-indigo-500/50 transition-colors">
                    ...
                    <input type="text" name="query" value="{{ request('query') }}" placeholder="Search for anime..."
