<x-admin-layout title="Kelola Paket Subscription">
    <div class="space-y-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold">Paket Subscription</h1>
                <p class="text-sm text-[#c7c4f3]">Atur harga dan durasi langganan</p>
            </div>
                ...
                <table class="w-full text-sm">
                    <thead class="text-xs uppercase tracking-wider text-[#c7c4f3] border-b border-white/10">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left">Durasi (Hari)</th>
                    ...
                    <tbody class="divide-y divide-white/10">
                        @forelse($subscriptions as $sub)
                            <tr class="hover:bg-white/5 transition">
                                ...
                                <td class="px-4 py-3">{{ $sub->duration_days }} Hari</td>
                                <td class="px-4 py-3">
                                    @if($sub->is_active)
