<x-admin-layout title="Edit Subscription Package">
    <div class="space-y-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-[#c7c4f3]">Edit subscription package for users</p>
            </div>
        </div>
        ...
        <div class="bg-[#352c6a] border border-white/10 rounded-2xl p-6 max-w-2xl">
            <form action="{{ route('admin.subscriptions.update', $subscription) }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $subscription->name) }}"
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" id="price" name="price" value="{{ old('price', $subscription->price) }}"
                        min="0" step="0.01"
                        class="w-full bg-[#2b235a] border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-[#a3a0d9] focus:outline-none focus:border-[#8b7cf6] transition"
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" id="duration_days" name="duration_days"
                        value="{{ old('duration_days', $subscription->duration_days) }}" min="1"
                        class="w-full bg-[#2b235a] border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-[#a3a0d9] focus:outline-none focus:border-[#8b7cf6] transition"
                ...
                <div class="flex items-center gap-3 pt-2">
                    <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $subscription->is_active) ? 'checked' : '' }}
